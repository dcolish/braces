...
import braces
from tests.common import PACKAGE_DIR, PROJECT_DIR, SPEC_TEST_DIR, UNITTEST_FILE_PREFIX
from tests.common import get_module_names
from tests.doctesting import get_doctests
from tests.spectesting import get_spec_tests
...
def main(sys_argv):
    ...
    print "braces: running tests: expecting source: %s" % should_source_exist
    ...
    _BracesTestProgram._text_doctest_dir = project_dir
    _BracesTestProgram._spec_test_dir = spec_test_dir
    ...
    _BracesTestProgram(argv=sys_argv, module=None)
...
class SetupTests(unittest.TestCase):
    ...
    def test_version(self):
        ...
        try:
            ...
            self.assertEqual(VERSION, braces.__version__)
        finally:
...
class _BracesTestProgram(TestProgram):
